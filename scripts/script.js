...
let allUsers = [
    {
        userFirstname: "Isaac",
        userLastname: "Oyedele",
        userEmail: "isaacoluwadarasimi002@gmail.com",
        userPassword: "isaac",
        isAgent: false,
        id: 1
      },
      {
        userFirstname: "Isaac",
        userLastname: "Oyedele",
        userEmail: "isaacoluwadarasimi02@gmail.com",
        userPassword: "isac",
        isAgent: false,
        id: 2
      },
      {
        userFirstname: "Dele",
        userLastname: "Oyedele",
        userEmail: "isaacoluwadara02@gmail.com",
        userPassword: "dele",
        isAgent: false,
        id: 3
      },
      {
        userFirstname: "Psylars",
        userLastname: "Oyedele",
        userEmail: "psylarsdele@gmail.com",
        userPassword: "pdey",
        isAgent: false,
        id: 4
      },
      {
        userFirstname: "Sharon",
        userLastname: "Oyedele",
        userEmail: "sharon@gmail.com",
        userPassword: "sharon",
        isAgent: false,
        id: 5
      }
    ...
    if (nam.value == "" || lnam.value == "" || email.value == "" || password.value == "" || c_password.value == "") {
        ...
        if (password.value != c_password.value) {
            ...
            if (users === null || users === "" || users === undefined) {
                ...
                let found = users.find(where => occ_details.Occ_email === where.Occ_email)
                if(found){
                    p.style.display = "block"
                    p.style.backgroundColor = "red"
...
function log(ev) {
    ev.preventDefault();
    // while (loginCheck.value == on) {
    //     loginCheck == true
    // }
    let found = users.find(where=> where.userEmail == gmail.value && where.userPassword == pass.value && where.isAgent == loginCheck.checked )
